...
inline int find_hvyslc_reuseBased(Tensor *arrX, const Tensor &X, TiledTensor *MTX, Options & Opt){
    ...
    cout << "fbrnnz replaced by slice nnz" << endl;
